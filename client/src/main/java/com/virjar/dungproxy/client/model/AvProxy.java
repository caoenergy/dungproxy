...
public class AvProxy {
	...
	public void recordProxyChange() {
		if (proxyNumberChange.incrementAndGet() % 10 == 0) {// 每当有10个IP加入或者下线,则进行一次序列化
			...
			dungProxyContext.getAvProxyDumper().serializeProxy(
					Maps.transformValues(IpPool.getInstance().getPoolInfo(),
	...
	public boolean equals(Object o) {
		...
		return ip != null ? ip.equals(avProxy.ip) : avProxy.ip == null
				&& (port != null ? port.equals(avProxy.port) : avProxy.port == null);
